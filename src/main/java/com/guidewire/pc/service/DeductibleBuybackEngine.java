...
public class DeductibleBuybackEngine {
    ...
    public static class BuybackResult {
        ...
        public BigDecimal getOriginalDeductible() { return originalDeductible; }
        public void setOriginalDeductible(BigDecimal originalDeductible) { this.originalDeductible = originalDeductible; }

        public BigDecimal getTargetDeductible() { return targetDeductible; }
        public void setTargetDeductible(BigDecimal targetDeductible) { this.targetDeductible = targetDeductible; }

        public double getBuybackSurchargePct() { return buybackSurchargePct; }
        public void setBuybackSurchargePct(double buybackSurchargePct) { this.buybackSurchargePct = buybackSurchargePct; }
        ...
        public BigDecimal getRevisedTotalPremium() { return revisedTotalPremium; }
        public void setRevisedTotalPremium(BigDecimal revisedTotalPremium) { this.revisedTotalPremium = revisedTotalPremium; }
    }
}
