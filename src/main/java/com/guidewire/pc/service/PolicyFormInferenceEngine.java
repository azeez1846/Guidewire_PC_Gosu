...
public class PolicyFormInferenceEngine {
    ...
    public static List<PolicyForm> inferPolicyForms(PolicyPeriod period) {
        ...
        String state = period.getBaseState() != null ? period.getBaseState() : "US";
        String prod = period.getProductCode() != null ? period.getProductCode() : "Generic";
        ...
        if (period.getTotalPremium() != null && period.getTotalPremium().doubleValue() >= 10000.0) {
