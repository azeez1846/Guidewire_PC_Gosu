...
public class GuidewirePolicyCenterServlet extends HttpServlet {
    ...
    private String renderHeader(String activeTab) {
        return "<div class='gw-header'>" +
                ...
                "<a href='/?page=features' class='gw-tab " + ("features".equals(activeTab) ? "active" : "") + "' style='background:linear-gradient(135deg, #FFD700, #FF8C00); color:#000; font-weight:bold; border-radius:4px;'>🚀 Features (29)</a>" +
    ...
    private String renderFeaturesPage() {
        ...
        sb.append("<div style='color:#718096; font-size:14px; margin-top:4px;'>Comprehensive suite of 29 enterprise-grade insurance industry engines & accelerators with interactive TypeScript/REST execution drivers.</div></div>");

        // Filter Bar
        sb.append("<div style='display:flex; gap:10px; margin-top:16px; flex-wrap:wrap;'>");
        sb.append("<button onclick=\"filterFeatures('all')\" class='gw-filter-btn active' id='btn-all'>All Features (29)</button>");
