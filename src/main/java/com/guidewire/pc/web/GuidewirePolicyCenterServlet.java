...
public class GuidewirePolicyCenterServlet extends HttpServlet {
    ...
    private String renderFeaturesPage() {
        ...
        sb.append("<script>")
          ...
          .append("{id:'property-prefill', title:'Property Pre-Fill & Hazard Intelligence Accelerator', category:'Underwriting & Risk', endpoint:'/rest/v1/accelerator/property-prefill', desc:'Auto-retrieves ISO Construction Classes (1-6), Year Built, Roof Specs, Public Protection Class, and Wildfire/Flood Risk Scores.', purpose:'Property intelligence lookup and building schedule prefill.', inputs:[{n:'address',l:'Property Address',t:'text',v:'100 Ocean Drive, Miami, FL'},{n:'zipCode',l:'ZIP Code',t:'text',v:'33139'}]},")
          .append("{id:'prior-loss', title:'Prior Loss & C.L.U.E. Auto-Retrieval Accelerator', category:'Underwriting & Risk', endpoint:'/rest/v1/accelerator/prior-loss', desc:'Retrieves 3-year loss history, computes loss ratio, and calculates experience modifier discount (-15%) or surcharge (+30%).', purpose:'Prior loss history check and experience modification.', inputs:[{n:'searchKey',l:'Search Identifier / FEIN',t:'text',v:'TAX-94-1829104-CLEAN'},{n:'annualEarnedPremium',l:'Baseline Premium ($)',t:'number',v:'45000.00'}]},")
          .append("{id:'reinsurance-slip', title:'ACORD Reinsurance Placement Slip & Bordereau Generator', category:'Reinsurance & Portfolio', endpoint:'/rest/v1/reinsurance/slip', desc:'Generates standardized ACORD Reinsurance Placement Slips, Quota Share cessions, and syndicate bordereaux for high-limit risks.', purpose:'Automated reinsurance documentation and ceding commission calculation.', inputs:[{n:'policyNumber',l:'Policy #',t:'text',v:'POL-COMM-PROP-8891'},{n:'treatyType',l:'Treaty Type',t:'text',v:'QUOTA_SHARE'},{n:'policyLimit',l:'Policy Limit ($)',t:'number',v:'20000000'},{n:'grossPremium',l:'Gross Premium ($)',t:'number',v:'65000'},{n:'quotaSharePct',l:'Quota Share Ceded %',t:'number',v:'40'}]},")
          .append("{id:'cp-endorsements', title:'Commercial Property Endorsements & Multi-Location Blanket Suite', category:'Specialty Lines', endpoint:'/rest/v1/cp/endorsements/rate', desc:'Rates Tenants Improvements & Betterments, Business Income (1/3, 1/4, 1/6 indemnity), Boiler & Machinery, and Blanket coverage pools.', purpose:'Commercial property endorsement pricing and blanket rate averaging.', inputs:[{n:'buildingLimit',l:'Building Limit ($)',t:'number',v:'1500000'},{n:'bppLimit',l:'BPP Limit ($)',t:'number',v:'350000'},{n:'tenantsImprovementLimit',l:'Improvements Limit ($)',t:'number',v:'150000'},{n:'businessIncomeLimit',l:'Business Income Limit ($)',t:'number',v:'300000'},{n:'equipmentBreakdownLimit',l:'Equipment Breakdown ($)',t:'number',v:'500000'},{n:'protectionClass',l:'Protection Class (1-10)',t:'text',v:'3'}]},")
          .append("{id:'audit-multiclass', title:'Commercial Multi-Class Payroll Audit & Dispute Engine', category:'Commercial Rating & Retrospective', endpoint:'/rest/v1/audit/multiclass/execute', desc:'Executes physical payroll audits across multiple class codes, state guaranty assessments, and dispute adjustments.', purpose:'Workers Comp and General Liability exposure audit reconciliation.', inputs:[{n:'policyNumber',l:'Policy #',t:'text',v:'POL-WC-AUDIT-901'},{n:'stateAssessmentPct',l:'State Assessment %',t:'number',v:'3.5'}]},")
          .append("{id:'quote-comparison', title:'Multi-Option Quote Comparison & Dynamic Tier Matrix', category:'Underwriting & Risk', endpoint:'/rest/v1/quote/compare-packages', desc:'Generates real-time side-by-side quote packages (Bronze Essential, Silver Preferred, Gold Enterprise) with customizable deductible tiers.', purpose:'Multi-tier quote comparison matrix for brokers and insureds.', inputs:[{n:'buildingLimit',l:'Building Limit ($)',t:'number',v:'1200000'},{n:'bppLimit',l:'BPP Limit ($)',t:'number',v:'300000'},{n:'protectionClass',l:'Protection Class (1-10)',t:'text',v:'3'}]}")
          .append("];")
